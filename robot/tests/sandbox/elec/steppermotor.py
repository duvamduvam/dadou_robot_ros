...
#
PUL = 24  # Stepper Drive Pulses
DIR = 22  # Controller Direction Bit (High for Controller default / LOW to Force a Direction Change).
ENA = 23  # Controller Enable Bit (High to Enable / LOW to Disable).
