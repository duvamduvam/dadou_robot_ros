...
class TestFace(unittest.TestCase):
    ...
    def test_img_mouth(self):
        ...
        self.face.pixels[(8*3)+64] = AMBER
        self.face.pixels[(8*3)+65] = AMBER
        self.face.pixels[(8*3)+66] = AMBER
        self.face.pixels[(8*3)+67] = AMBER
        self.face.pixels[(8*3)+68] = AMBER
        self.face.pixels[(8*3)+69] = AMBER
        self.face.pixels[(8*3)+70] = AMBER
        self.face.pixels[(8*3)+71] = AMBER
