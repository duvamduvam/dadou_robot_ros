...
ros2 launch robot_sim sim.launch.py headless:=${HEADLESS:-false} animations:=${ANIMATIONS:-false} web:=${WEB:-false} web_port:=${WEB_PORT:-8765} web_drive:=${WEB_DRIVE:-false} face:=${FACE:-false} face_port:=${FACE_PORT:-8766}
