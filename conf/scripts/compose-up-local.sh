...
if [ "$1" == "build" ]; then
    ...
    sudo docker compose -f /home/dadou/Nextcloud/Didier/python/dadou_robot_ros/conf/docker/x8664/docker-compose.yml up --build
else
    # Sinon, exécute sans l'option --build
    sudo docker compose -f /home/dadou/Nextcloud/Didier/python/dadou_robot_ros/conf/docker/x8664/docker-compose.yml up
fi
